...
namespace QuanLyMyPham.DAL
{
    internal class HoaDonBanDAL : IHoaDonBanDAL
    {
        ...
        {
            string query =
                $"insert into HoaDonBan(NgayBan,TenKhach,SDT,DiaChi,MaNV) values('{hoaDonBan.NgayBan.Value.ToString("yyyy-M-d")}',N'{hoaDonBan.TenKhach}','{hoaDonBan.SDT}',N'{hoaDonBan.DiaChi}',{hoaDonBan.MaNV})";
        ...
        {
            string query =
                $"update HoaDonBan set DiaChi = N'{hoaDonBan.DiaChi}',MaNV = {hoaDonBan.MaNV}, NgayBan = '{hoaDonBan.NgayBan.Value.ToString("yyyy-M-d")}',SDT = '{hoaDonBan.SDT}',TenKhach = N'{hoaDonBan.TenKhach}'";
            return DBHelper.NonQuery(query, null);
        }
    }
}